...
<asp:Content ID="Content1" ContentPlaceHolderID="Body" runat="Server">
    ...
    <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=Lab13Entities" DefaultContainerName="Lab13Entities" EnableFlattening="False" EntitySetName="Students"></asp:EntityDataSource>
</asp:Content>
