...
<asp:Content ID="Content1" ContentPlaceHolderID="Body" Runat="Server">
    ...
    <table border="0">
        <tr>
          ...
          <tr>
            <td>
                &nbsp;</td>
            <td>
                <asp:CheckBox ID="chkOnlyUnexcused" Text="Only Unexcused" AutoPostBack="true" runat="server" OnCheckedChanged="chkOnlyUnexcused_CheckedChanged" />
       ...
       <tr>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="grvAttendance" AutoGenerateColumns="false" runat="server" OnRowDataBound="grvAttendance_RowDataBound"  >
                    <Columns>
