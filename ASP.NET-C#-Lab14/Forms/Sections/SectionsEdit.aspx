...
<asp:Content ID="Content1" ContentPlaceHolderID="Body" runat="Server">
    ...
    <asp:GridView ID="grvSections" AutoGenerateColumns="false" runat="server" >
        <Columns>
            <asp:BoundField DataField="SectionName" HeaderText="Sections"  ItemStyle-Width="150px"/>
            <asp:BoundField DataField="StudentCount" HeaderText="Registered" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right"  ItemStyle-Width="150px"/>
        </Columns>
    </asp:GridView>
</asp:Content>
